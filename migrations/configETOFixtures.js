...
export const defEtoTerms = {
  ...
  etoTerms: {
    ...
    EXISTING_SHARE_CAPITAL: new web3.BigNumber(40976),
...
export const hnwiEtoDeSecurityTerms = {
  ...
  etoTerms: {
    ...
    TOKEN_TERMS: null,
    SHARE_CAPITAL_CURRENCY_CODE: "EUR",
    EXISTING_SHARE_CAPITAL: new web3.BigNumber(41976),
