...
module.exports = function deployContracts(deployer, network, accounts) {
  ...
  deployer.then(async () => {
    ...
    await commitment.commit({
      ...
      value: CONFIG.Q18.times(161.1289798),
    });
    await commitment.commit({
      from: fas.INV_ETH_EUR_ICBM_M_HAS_KYC.address,
      value: CONFIG.Q18.times(218.1289798),
    });
    await commitment.commit({
    ...
    await commitment.commit({
      ...
      value: CONFIG.Q18.times(1211.1289798),
    });
    await commitment.commit({
    ...
    let amountEur = CONFIG.Q18.times(1781267);
    ...
    amountEur = CONFIG.Q18.times(71827);
    ...
    amountEur = CONFIG.Q18.times(812988.1988);
