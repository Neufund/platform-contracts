...
test-invest-into-eto-script: container
	...
	docker exec platform-contracts yarn truffle exec scripts/investIntoETO.js --network cmdline_pk_localhost  --universe 0x9bad13807cd939c7946008e3772da819bd98fa7b --pk 0x44bdba69b6ca73889a8580e6968349677ed577bea3fa417c142bcc57cdcedd5b --eto `node ./scripts/fixtures/getETOFixtureAddress.js ETOInPublicState` --amount 10 --currency ETH --skip_confirmation
	docker exec platform-contracts yarn truffle exec scripts/investIntoETOCheck.js --network cmdline_pk_localhost  --pk 0x44bdba69b6ca73889a8580e6968349677ed577bea3fa417c142bcc57cdcedd5b --eto `node ./scripts/fixtures/getETOFixtureAddress.js ETOInPublicState` --amount 10
	$(MAKE) down
