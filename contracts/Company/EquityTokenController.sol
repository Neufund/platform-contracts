    ...
    Reclaimable
{
    ...
    modifier onlyLastETO() {
        ...
        require(!IETOCommitment(msg.sender).finalized(), "ETC_ETO_NOT_FIN");
        // must be known ETO
        require(mIsRegisteredOffering(msg.sender), "ETC_ETO_NK");
        _;
    }
        ...
        onlyCompany
    {
        ...
        require(from == COMPANY_LEGAL_REPRESENTATIVE, "ETC_TF_O_LEGALREP");
        ...
        if(_state == GovState.Closing) {
            require(expectedAmount == amount, "ETC_PROC_CLS_FULL");
        } else {
            require(expectedAmount >= amount, "ETC_PROC_EXC");
        }
        // bookeeping
        ...
        onlyState(GovState.Closing)
    {
        ...
        require(!canCancelCompanyClosing(), "ETC_CLOSE_CAN_CANCEL");
        // revert if there any pending obligations (currently proceeds)
        require(canCloseCompany(), "ETC_CLOSE_OBLIG");
    ...
    function cancelCompanyClosing()
        ...
        onlyState(GovState.Closing)
    {
        require(canCancelCompanyClosing(), "ETC_CLOSE_CANNOT_CANCEL");
        ...
        private
    {
        ...
        require(legalRep == _nominee, "NDT_ET_A_MIS");
        require(equityToken.nominee() == _nominee, "NDT_ET_N_MIS");
        ...
        require(legalRep == _nominee, "NDT_ETO_A_MIS");
